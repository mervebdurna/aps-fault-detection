...
class DataTransformation:
    ...
    def initiate_data_transformation(self):
        try:
            ...
            logging.info(f"Selectiong input features for train and test dataframe")
            ...
            logging.info(f"Transformation on targert column")
            ...
            logging.info(f"concatinate input_feature and target array for train and test data ")
            train_arr = np.c_[input_feature_train_arr, target_feature_train_arr ]
            test_arr = np.c_[input_feature_test_arr, target_feature_test_arr]

            logging.info(f"Save train and test numpy array")
            utils.save_numpy_array_data(file_path=self.data_transformation_config.transformed_train_path, array=train_arr)
            utils.save_numpy_array_data(file_path=self.data_transformation_config.transformed_test_path,array=test_arr)

            logging.info(f"Save transformer objects")
